...
// coutput(i, e) is (bargraph, min, max); the bargraph box has one input.
// Outputs: 0.25 through the bargraph, -1, 1, then 1 bargraph.
e = hslider("b", 0.5, 0, 1, 0.1) * 10 + hslider("a", 0.25, 0, 2, 0.1) * 100
  ...
  : hbargraph("m", -1, 1);
process = 0.25 : coutput(0, e), outputs(coutputs(e));
